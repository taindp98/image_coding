...
[t0,s0] = compute_ssim(ORIGINAL_VID_PATH,COMP_VID_PATH_50);
[t1,s1] = compute_ssim(ORIGINAL_VID_PATH,COMP_VID_PATH_40);
[t2,s2] = compute_ssim(ORIGINAL_VID_PATH,COMP_VID_PATH_30);
[t3,s3] = compute_ssim(ORIGINAL_VID_PATH,COMP_VID_PATH_20);
