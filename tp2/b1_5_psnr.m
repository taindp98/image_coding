...
[t0,p0] = compute_psnr(BLUR_VID_PATH,COMP_VID_PATH_50);
[t1,p1] = compute_psnr(BLUR_VID_PATH,COMP_VID_PATH_40);
[t2,p2] = compute_psnr(BLUR_VID_PATH,COMP_VID_PATH_30);
[t3,p3] = compute_psnr(BLUR_VID_PATH,COMP_VID_PATH_20);
